...
This is a step-by-step guide for building the CertMind multi-agent system. Each task builds on the previous.
...
✅ **Phase 1 done when**: Repo is live on GitHub with skeleton structure

---

## PHASE 2 — Foundry IQ Knowledge Base + Base Agent
...
- Verify Microsoft Learn content is retrieved
  ✅ **Phase 2 done when**: Curator returns cited answers from Foundry IQ

---

## PHASE 3 — Study Plan Generator + Fabric IQ
...
✅ **Phase 3 done when**: Planner outputs a structured, realistic study schedule

---

## PHASE 4 — Engagement Agent + Work IQ
...
✅ **Phase 4 done when**: Agent outputs personalised, timing-aware suggestions (not generic reminders)

---

## PHASE 5 — Critic/Verifier + Assessment Agent
...
- Assessment Agent output → Critic reviews it → only approved output reaches the learner
  ✅ **Phase 5 done when**: Assessment loop works with critic gating output

---

## PHASE 6 — Manager Insights + Orchestrator
...
✅ **Phase 6 done when**: Full end-to-end flow works from one natural language input
...
- Add a safety fallback message when guardrails trigger
  ✅ **Phase 7 done when**: Evaluation harness runs and telemetry appears in Azure Monitor

---

## PHASE 8 — Hosted Agent Deployment
...
- Verify it returns the same results as local
  ✅ **Phase 8 done when**: Live hosted endpoint responds correctly
